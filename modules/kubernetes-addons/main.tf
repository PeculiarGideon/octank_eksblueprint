...
module "aws_managed_grafana" {
  count                        = var.enable_aws_managed_grafana ? 1 : 0
  source                       = "./aws-managed-service-grafana"
  name                         = var.aws_managed_grafana_terraform_config.name
  associate_license            = var.aws_managed_grafana_terraform_config.associate_license 
  description                  = var.aws_managed_grafana_terraform_config.description
  account_access_type          = var.aws_managed_grafana_terraform_config.account_access_type 
  authentication_providers     = var.aws_managed_grafana_terraform_config.authentication_providers
  permission_type              = var.aws_managed_grafana_terraform_config.permission_type
  data_sources                 = var.aws_managed_grafana_terraform_config.data_sources  
  notification_destinations    = var.aws_managed_grafana_terraform_config.notification_destinations
  stack_set_name               = var.aws_managed_grafana_terraform_config.stack_set_name 
  //role_associations            = var.aws_managed_grafana_terraform_config.role_associations   
